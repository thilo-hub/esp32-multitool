...
send_pattern(gptimer_handle_t timer, const gptimer_alarm_event_data_t * edata, void *user_data)
{
...
QueueHandle_t 
create_rf433_manager(gptimer_handle_t lgptimer)
{
	gptimer = lgptimer;
